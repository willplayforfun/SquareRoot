...
namespace InControl
{
	...
	public class InControlInputModule : StandaloneInputModule
	{
		...
		public PlayerAction SubmitAction { get
            {
                return null;// FromLight.FromLightInputManager.input.submit;
            }
        }
		...
		public PlayerAction CancelAction {
            get
            {
                return null;// FromLight.FromLightInputManager.input.cancel;
            }
        }

		public PlayerTwoAxisAction MoveAction { get
            {
                return null;// FromLight.FromLightInputManager.input.leftStick;
            }
        }
